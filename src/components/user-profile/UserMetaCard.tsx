...
import { createUserEntry } from "@/redux/api/thunks/users/post";
...
export default function UserMetaCard() {
  ...
  const noRemote = params.get("no-remote") === "true";
...
const handleSave = async () => {
  ...
  const userData = {
    ...
    which_key: formData.username,
    identifier: `${formData.username} - ${formData.email} - ${new Date().toISOString().slice(0, 10)}`,
    expoNotificationId: 'to-be-set',
    id_on_device: 1,
  ...
  const userCreationResponse = await dispatch(createUserEntry({data:userData})).unwrap();

  if (userCreationResponse) {
    closeModal();
    toast.success("User details confirmed successfully! welcome to Book Assist.");
    console.log("User details saved successfully:", userCreationResponse);
    ...
    <>
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
          ...
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            ...
            <div className="order-3 xl:order-2">
              ...
              <div className="flex flex-col items-center gap-1 text-center xl:flex-row xl:gap-3 xl:text-left">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  Book Assist (Your business in your palm)
                </p>
              </div>
              {noRemote && (
            ...
            <div className="flex items-center order-2 gap-2 grow xl:order-3 xl:justify-end">
              <a        
        target="_blank"
        rel="noreferrer" href='https://www.facebook.com/Shaunv1.0.0' className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                <svg
              ...
              <a href='https://x.com/shaun_s01' target="_blank"
        rel="noreferrer"  className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
              ...
              <a href="https://www.linkedin.com/in/shaun-sungai-kdtk/" target="_blank"
        rel="noreferrer" className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                <svg
                  className="fill-current"
                  width="20"
              ...
              <a href='https://instagram.com/__kdtk' target="_blank"
        rel="noreferrer" className="flex h-11 w-11 items-center justify-center gap-2 rounded-full border border-gray-300 bg-white text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                <svg
                  className="fill-current"
                  width="20"
