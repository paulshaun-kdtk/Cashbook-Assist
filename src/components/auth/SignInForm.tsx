...
export default function SignInForm() {
  ...
  const { error, loading, authenticated } = useSelector((state) => state.auth);
    ...
    async function handleUsernameCheck() {
      ...
      try {
        const result = await confirmUserNameBelongsToUser(email, privateId);
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <Input type="text" name="private_id"
                  disabled={!email}
                  onChange={(e) => {
                  ...
                  {usernameAvailable === false && (
                    <p className="mt-2 text-sm text-red-500 dark:text-red-400">
                      This user_name does not match with the one you signed up with. Click <a className="text-emerald-500 underline text-base" href={"mailto:support@shsoftwares.com?subject=Username recovery"} target="__blank" >here</a> if you have forgotten it and need help recovering it... or contact support using our call centers.
                    </p>
                  )}
              ...
              <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="block font-normal text-gray-700 text-theme-sm dark:text-gray-400">
                      I agree to the terms of app usage
                    </span>
                  </div>
                  <Link
                    href="/reset-password"
                ...
                <div>
                  <Button className="w-full" size="sm" disabled={!isChecked || loading || checkingUsername}>
