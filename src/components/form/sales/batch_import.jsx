...
import { handleSaleDataUpload } from "@/utils/formatters/modules/sales_data_formatter";
import { createSaleItemThunk } from "@/redux/api/thunks/sales/post";
import DropzoneComponent from "../components/form-elements/DropZone";
import { useDispatch, useSelector } from "react-redux";
import Button from "@/components/ui/button/Button";

export const SalesBatchImport = () => {
    ...
    const handleFileUpload = async (files) => {
        try {
          const data = await handleSaleDataUpload({
            files,
