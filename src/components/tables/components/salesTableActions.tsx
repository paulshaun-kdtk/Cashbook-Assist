...
export const SalesFilters = () => {
  ...
  const key = localStorage.getItem("unique_id")

  React.useEffect(() => {
    dispatch(fetchCustomersThunk(key))
    dispatch(fetchStockThunk(key))
  }, [dispatch, key]);
  ...
  const handleProductCategoryChange = (selected) => {
    ...
    console.log("Selected Product Categories:", selected);
  };
    ...
    <div className="p-6 rounded-xl shadow-lg dark:bg-gray-800 max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap items-end gap-4 md:gap-6">
        ...
        <div className="w-full sm:w-auto flex-grow min-w-[150px]">
          <Label htmlFor="min-sales">Min Sales</Label>
          <Input
            id="min-sales"
            type="number"
            placeholder="e.g., 100"
        ...
        {/* Max Sales Input */}
        <div className="w-full sm:w-auto flex-grow min-w-[150px]">
          <Label htmlFor="max-sales">Max Sales</Label>
          <Input
            id="max-sales"
            type="number"
