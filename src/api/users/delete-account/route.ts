...
export async function DELETE(req: Request) {
  try {
    ...
    const collections = [
      ...
      { id: appwriteCreds.customer_collection_id, name: "customers" },
      { id: appwriteCreds.stock_item_collection_id, name: "stock_items" },
      { id: appwriteCreds.sale_collection_id, name: "sales" },
      { id: appwriteCreds.credit_collection_id, name: "credits" },
      { id: appwriteCreds.debt_collection_id, name: "debts" },
      { id: appwriteCreds.wishlist_collection_id, name: "wishlist" },
